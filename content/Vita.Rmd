...
# [Curriculum Vitae]{.smallcaps style='letter-spacing: 3px;'}
...
jsonlite::read_json("../data/My Talks.json", simplifyVector = T) %>% 
  ...
  mutate(citation = glue::glue(
    '<div class="csl-entry">{author} ({date}). {title} [{genre}]. {`event-title`}, {`event-place`}.   {URL}</div>')) %>% 
...
* For the year 2022, I am an external adviser for Pearson Clinical Assessment's Scientific Council. For my time, I receive an honorarium. 
