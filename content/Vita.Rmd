...
#. *Virtual Charter School Performance Reviews and Support* (PI), with Christopher McGinley, Sarah Cordes, and Annemarie Hindman, $511,560, Pennsylvania Department of Education [(2020–2021)]{.smalldate}.
...
ggplot(ct, aes(year, cumulative_citations)) + 
  ...
  scale_x_continuous("Publication Year", minor_breaks = 2000:2021) +
...
tibble::tribble(
  ...
  "2019–2021", "*Journal of Psychoeducational Assessment*",    "Associate Editor",
